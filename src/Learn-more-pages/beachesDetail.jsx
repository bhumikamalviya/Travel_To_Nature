...
export function BeachDetail() {
  ...
  // Default main image = beach.image
  const [mainImage, setMainImage] = useState(beach ? beach.image : "");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-hidden p-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[...beach.images].slice(0, 2).map((img, index) => (
              <div
                key={index}
        ...
        <div className="p-4 flex flex-col justify-center">
          ...
          <p className="mt-4 font-semibold text-green-600 font-['Roboto']">
            Best Time to Visit: {beach.best_time_to_visit}
          </p>
